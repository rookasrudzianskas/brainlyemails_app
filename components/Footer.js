...
const Footer = () => {
    return (
        <div>
            ...
            <footer className=" mt-36 bg-[#162044] dark:bg-gray-800 pt-4 pb-8 xl:pt-8">
                <div
                    ...
                    <ul className="text-lg font-light pb-8 flex flex-wrap justify-center">
                        <li className="w-1/2 md:w-1/3 lg:w-1/3">
                            <div className="text-center">
                                ...
                                <ul>
                                    <li className="mb-4 hover:text-gray-800 font-medium dark:hover:text-white hover:text-[#5886D9] rounded-xl duration-200">
                                        <a href="#">
                                            Dashboard
                                        </a>
                                    </li>
                    ...
                    <div className="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
                        <form
                            ...
                            <button
                                className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-[#0059F7] rounded-lg shadow-md hover:bg-[#5886D9]] focus:outline-none focus:ring-2 focus:ring-[#5886D9] focus:ring-offset-2 focus:ring-offset-[#5886D9]"
                                type="submit">
                                Subscribe
                            </button>
                        </form>
                    ...
                    <div className="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
                        © Brainlyemails startup with ❤️ by {" "} <a href="https://www.byrookas.com"> {" "} Rokas Rudzianskas</a>
                    </div>
                </div>
            </footer>
