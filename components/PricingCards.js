                ...
                <ul className="text-sm text-white w-full mt-6 mb-6">
                    ...
                    <li className="mb-3 flex items-center ">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6"
                             stroke="currentColor" fill="white" viewBox="0 0 1792 1792">
                            <path
                                d="M1412 734q0-28-18-46l-91-90q-19-19-45-19t-45 19l-408 407-226-226q-19-19-45-19t-45 19l-91 90q-18 18-18 46 0 27 18 45l362 362q19 19 45 19 27 0 46-19l543-543q18-18 18-45zm252 162q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z">
                            </path>
                        </svg>
                        <p className="text-[#7E8BB6] text-xl">7,000+ Emails</p>
                    </li>
                    ...
                    <li className="mb-3 flex items-center ">
                        ...
                        <p className="text-[#7E8BB6] text-xl">All unlimited components</p>
                    </li>
                    <li className="mb-3 flex items-center ">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6"
                             stroke="currentColor" fill="white" viewBox="0 0 1792 1792">
                        ...
                        <p className="text-[#7E8BB6] text-xl">Own custom Brainlyemails styles</p>
                    </li>
                    <li className="mb-3 flex items-center ">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6"
                             stroke="currentColor" fill="white" viewBox="0 0 1792 1792">
                        ...
                        <p className="text-[#7E8BB6] text-xl">Unlimited Templates</p>
                    </li>
                    <li className="mb-3 flex items-center ">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6"
                             stroke="currentColor" fill="white" viewBox="0 0 1792 1792">
                        ...
                        <p className="text-[#7E8BB6] text-xl">Free premium dashboard</p>
                    </li>
                    <li className="mb-3 flex items-center ">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6"
                             stroke="currentColor" fill="white" viewBox="0 0 1792 1792">
                        ...
                        <p className="text-[#7E8BB6] text-xl">Best ranking</p>
                    </li>
                        ...
                        <li className="mb-3 flex items-center ">
                            ...
                            <p className="text-[#7E8BB6] text-xl">Dedicated Support</p>
                        </li>

                </ul>
                <button type="button"
                        className="w-full px-3 mt-5 py-3 text-sm shadow rounded-lg text-indigo-500 bg-[#424D71] hover:bg-[#4D5986] duration-200 ">
                    <p className="text-[#FFFFFF] text-xl">Choose plan</p>
                </button>
            </div>
                ...
                month
                    ...
                    <ul className="text-sm text-white w-full mt-6 mb-6">
                        ...
                        <li className="mb-3 flex items-center ">
                            ...
                            <p className="text-[#7E8BB6] text-xl">20,000+ Emails</p>
                        </li>
                        ...
                        <li className="mb-3 flex items-center ">
                            ...
                            <p className="text-[#7E8BB6] text-xl">Custom Domain & SSL</p>
                        </li>
                ...
                month
                    ...
                    <ul className="text-sm text-white w-full mt-6 mb-6">
                        ...
                        <li className="mb-3 flex items-center ">
                            ...
                            <p className="text-[#7E8BB6] text-xl">50,000+ Emails</p>
                        </li>
                        ...
                        <li className="mb-3 flex items-center ">
                            ...
                            <p className="text-[#7E8BB6] text-xl">100GB of storage per month</p>
                        </li>
                        ...
                        <li className="mb-3 flex items-center ">
                            ...
                            <p className="text-[#7E8BB6] text-xl">AI email builder Beta</p>
                        </li>
